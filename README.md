...
- Set rules at **version**, with **Up to Next Major** option and put **3.0.8** as its version
- Click next and wait
...
```swift
dependencies: [
    .package(url: "https://github.com/nayanda1/Artisan.git", .upToNextMajor(from: "3.0.8"))
]
```
